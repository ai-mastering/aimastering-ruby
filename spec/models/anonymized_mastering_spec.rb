...
# Unit tests for Aimastering::AnonymizedMastering
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnonymizedMastering' do
  before do
    # run before each test
    @instance = Aimastering::AnonymizedMastering.new
  end
  ...
  describe 'test an instance of AnonymizedMastering' do
    it 'should create an instance of AnonymizedMastering' do
      expect(@instance).to be_instance_of(Aimastering::AnonymizedMastering)
    end
  end
  ...
  describe 'test attribute "user_auth_provider"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "payment_service"' do
    it 'should work' do
       ...
       #validator.allowable_values.each do |value|
       #  expect { @instance.payment_service = value }.not_to raise_error
       #end
    end
  end
